    ...
    return (
        <div className="w-full text-white">
            ...
            <Section className="items-start">
                <h1 className="text-5xl md:text-9xl font-light tracking-tighter leading-tight">
                    ROBOTICS<br />
                    <span className="font-bold text-primary">& NUCLEAR POWER</span>
                </h1>
                <p className="mt-6 text-lg md:text-xl max-w-md text-gray-400">
            ...
            <Section className="items-end text-right">
                <div className="max-w-xl">
                    <h2 className="text-3xl md:text-5xl font-bold mb-6">/AUTONOMOUS ASSEMBLY</h2>
            ...
            <Section className="items-start">
                <div className="max-w-xl bg-black/50 p-8 backdrop-blur-md border-l-2 border-primary">
                    <h2 className="text-3xl md:text-5xl font-bold mb-6">/CRITICAL REACTION</h2>
                    <p className="text-lg text-gray-300">
            ...
            <Section className="items-center text-center">
                <div className="max-w-2xl">
                    <h2 className="text-3xl md:text-5xl font-bold mb-6">/GRID DISPERSION</h2>
                    <p className="text-lg text-gray-300">
